...
const RestaurantCard: React.FC<Props> = ({ restaurant }) => {
    ...
    const fullAddress = `${restaurant.address.no}, ${restaurant.address.street}, ${restaurant.address.town}, ${restaurant.address.city}, ${restaurant.address.postal_code}`;
    ...
    return (
        <Card className="food-card rounded-2xl overflow-hidden border-2 border-border bg-card">
            ...
            <CardContent className="px-4 pb-4 space-y-3">
                ...
                className="btn-hover-effect w-full mt-2 py-2 px-4 rounded-xl bg-primary text-primary-foreground font-medium"
                >
                    View Restaurant
                </Button>
            </CardContent>
