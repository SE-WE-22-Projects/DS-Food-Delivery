        ...
        <section className={cn("w-full py-12 md:py-24 lg:py-32", className)}>
            <div className=" px-4 md:px-6 w-full mx-auto">
                <div className="flex md:flex-row flex-col container mx-auto">
                    <div className="flex flex-col w justify-center space-y-4 w-full md:mx-12 grow">
                        <motion.h1 className="text-orange-500 hover:text-orange-600 text-4xl font-bold sm:text-6xl xl:text-7xl/none mb-12 mx-auto md:mx-0">
                            ...
                            <span className="block">
                                ...
                                <AnimatePresence>
                                    <motion.span
                                        ...
                                        className="absolute inline-block text-orange-500 hover:text-orange-600 z-10">
                                        {current.name}
                                    </motion.span>
                                </AnimatePresence>
                        ...
                        <p className="md:text-xl max-w-[60vw] md:mx-0 mx-auto">
