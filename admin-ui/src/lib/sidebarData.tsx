...
import RestaurentManagement from "@/pages/RestaurentManagement";
...
export const sidebarData: AppSidebarProps[] = [
    ...
    },
    {
        ...
        itemList: [
            { itemName: "Restaurent Management", url: "/dashboard/restaurents", icon: UtensilsCrossed, element: <RestaurentManagement/> },
