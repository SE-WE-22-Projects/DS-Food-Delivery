...
const MenuDetails = () => {
    ...
    const {data} = useQuery({ queryKey: ['menu', menuId], queryFn: () => api.menu.getMenuItemById(menuId!) });
  return (
      <div className="p-6 md:p-10 max-w-5xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col items-center text-center mb-6 space-y-3">
              ...
              <Badge
                  className="flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-full text-lg"
              >
          ...
          {/* Description */}
          <div className="bg-muted p-6 rounded-xl shadow-md text-center text-green-200 mb-10 w-full md:w-4/5">
